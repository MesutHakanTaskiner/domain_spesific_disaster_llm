...
def main():
    ...
    ap.add_argument("--input", default="data/humaid_help_calls.csv", help="Input CSV path")
    ap.add_argument("--output", default="disaster_template_dataset_humaid.json", help="Output JSON path (or basename if splitting)")
